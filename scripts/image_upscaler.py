...
# %%
low_res_img = get_low_res_img()

# %%
prompt = "aesthetic image, UHD, 4k, hyper realistic, extremely detailed, professional, vibrant, not grainy, smooth"
upscaled_image = pipeline(prompt=prompt, image=low_res_img).images[0]
upscaled_image.save("C:/Users/Serious Tim/eclipse-workspace/Perspective-Crop/imgs/resultIA.jpg")
